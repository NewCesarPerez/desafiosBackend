...
import ejs from 'ejs'
import Puerto from "./yargs/configuration.js"
...
import { getFailSignUp, getSignup, getLogIn, getHome, getFailLogin, getInfo, getRandomCount } from "./routes/routes.js";
...
app.get('/api/randoms', getRandomCount)
